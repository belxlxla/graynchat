    ...
    <div className="h-full w-full flex flex-col bg-[#000000] text-white">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-10 pb-24">
          ...
          <div className="space-y-4">
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-[#2C2C2E] rounded-xl flex items-center justify-center text-red-500 group-hover:text-white transition-colors">
                  <Send className="w-6 h-6" />
                </div>
                <div className="text-left">
                  <div className="flex items-center gap-2 mb-0.5">
                    <p className="font-bold text-white text-lg">새 캡슐 보내기</p>
                    <span className="text-[11px] font-bold text-red-500 bg-orange-500/10 px-2 py-0.5 rounded border border-red-500/20">
                      ₩4,900
                    </span>
                  </div>
                          ...
                          <div key={c.id} 
                            ...
                            className={`p-4 rounded-xl border flex items-center justify-between transition-colors ${
                              locked 
                                ...
                                : 'bg-[#252525] border-red-500/20 text-white cursor-pointer hover:bg-[#2a2a2a]'
                            }`}
                          >
                            <div className="flex items-center gap-4">
                              <div className={`w-10 h-10 rounded-full flex items-center justify-center ${locked ? 'bg-[#2C2C2E]' : 'bg-red-500/10'}`}>
                                {locked ? <Lock className="w-5 h-5 text-gray-600" /> : <Unlock className="w-5 h-5 text-red-500" />}
                              </div>
                              <div>
        ...
        <section>
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-[#2C2C2E] rounded-xl flex items-center justify-center text-yellow-500 group-hover:text-white transition-colors">
                <Sparkles className="w-6 h-6" />
              </div>
              <div className="text-left">
                <div className="flex items-center gap-2 mb-0.5">
                  <p className="font-bold text-white text-lg">AI 친구 리포트</p>
                  <span className="text-[11px] font-bold text-yellow-400 bg-yellow-500/10 px-2 py-0.5 rounded border border-yellow-500/20">
                    ₩2,900
                  </span>
                </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <FeatureCard icon={<MessageSquare />} title="채팅 도우미" desc="AI 답장 추천받기" />
            <FeatureCard icon={<ListTodo />} title="대화 요약" desc="3줄 핵심 요약" />
            <FeatureCard icon={<CalendarCheck />} title="일정 비서" desc="약속 자동 추출" />
            <FeatureCard icon={<FileBarChart />} title="서류 생성" desc="견적서/영수증 보내기" />
          </div>
        </section>
      </div>
    </div>
