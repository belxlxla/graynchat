      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar pb-10">
        ...
        <div className="p-5 space-y-8">
          ...
          <div>
            ...
            <p className="text-[12px] text-[#FF203A]">* 표시 항목은 필수사항입니다.</p>
          </div>
          ...
          <Section title="불법촬영물 등 신고대상">
            {reportList.map((item, index) => (
              <div key={item.id} className="mb-4 p-4 bg-[#2C2C2E] rounded-xl border border-[#3A3A3C] relative">
                {index > 0 && (
                  <button onClick={() => removeReportRow(item.id)} className="absolute top-2 right-2 p-1 text-[#FF203A]">
                  ...
                  <div className="flex gap-2">
                    <div className="flex-1 relative">
                      <input 
                        ...
                        className="w-full h-10 bg-[#2C2C2E] border border-[#3A3A3C] rounded-lg px-3 text-sm text-white focus:border-brand-DEFAULT outline-none" 
                      />
                      <span className="absolute right-3 top-3 text-xs text-[#FF203A] font-mono">{formatTime(timer)}</span>
                    </div>
          ...
          <div className="pt-4 pb-8">
            ...
            <p className="text-[12px] text-[#FF203A] mb-8 flex gap-1 items-start">
            ...
            <div className="flex gap-3">
              ...
              <button 
                ...
                className="flex-1 h-12 bg-[#FF203A] rounded-xl text-white font-bold hover:bg-[#FF203A] transition-colors shadow-lg shadow-red-900/20"
              >
                신고접수
              </button>
            </div>
